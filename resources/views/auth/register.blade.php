...
<x-authentication-card>
    ...
    <x-splade-form class="space-y-4">
        ...
        <x-splade-input id="password_confirmation" name="password_confirmation" type="password" :label="__('main.confirm_password')"
        ...
        <Link href="{{ route('login') }}"
            class="inline-block underline text-sm text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-400 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
